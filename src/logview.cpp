static char *logview_id = 
	"@(#)Copyright (C) H.Shirouzu and Asahi Net, Inc. 2015-2017   logview.cpp	Ver4.50";
/* ========================================================================
...
//		{ REV_BTN,    ToolBar::BTN,  ASC_BITMAP,       TRect(  0, 1,  24, 28), IDS_REVTIP },
		...
		{ USER_COMBO, ToolBar::HOLE, NULL,             TRect( 14, 4, 100, 28) },
...
BOOL TLogView::EvCommand(WORD wNotifyCode, WORD wID, LPARAM hwndCtl)
{
	...
	case MENU_FINDLRUCLEAR:
		if (TMsgBox(this).Exec(LoadStrU8(IDS_CLEARFINDLRU), IP_MSG, MB_OKCANCEL,
			FALSE) == IDOK) {
