/*	@(#)Copyright (C) H.Shirouzu and Asahi Net, Inc. 2015-2017   logchildview.h	Ver4.50 */
/* ========================================================================
...
//	HFONT		hTinyFont;
	...
	BOOL	PaintPushBox(TRect rc, BoxType type, BOOL is_direct=FALSE);
	...
	int		PaintMsg(ViewMsg *msg, int top_y);
